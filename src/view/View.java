...
public class View
{
	...
	{
		System.out.println(
				"0. Cargar comparendos y estaciones de policía de la malla vial de Bogotá (2018) dentro del grafo hecho" );
		System.out.println( "   a partir de las fuentes de datos.\n" );
		System.out.println( "1. (A-1) Obtener el camino de costo mínimo entre dos ubicaciones geográficas." );
		System.out.println(
				"2. (A-2) Determinar la red de comunicaciones que soporte la instalación de cámaras de video en los M puntos donde se presentan los comparendos de mayor gravedad.\n" );
		System.out.println( "3. (B-1) Obtener el camino de costo mínimo entre dos ubicaciones geográficas." );
		System.out.println(
				"4. (B-2) Determinar la red de comunicaciones que soporte la instalación de cámaras de video entre los M puntos donde se presenta la mayor cantidad de comparendos en la ciudad.\n" );
		System.out.println(
